...
const SignupForm = () => {
  ...
  return (
    <>
      <form className=' bg-gradient-to-br from-primary to-secondary m-auto my-16 max-w-[500px] p-8 bg-white border-md shadow-inner rounded-md '>
        {loading ? (
          <Loader />
        ) : (
          <>
            ...
            <button className='bg-primary text-white px-4 py-2 font-medium hover:bg-primary-dark rounded-md' onClick={handleSubmit}>Submit</button>

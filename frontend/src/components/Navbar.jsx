...
const Navbar = () => {
  ...
  return (
    <>
      <header className='bg-gradient-to-br from-blue-300 to-blue-100 flex justify-between sticky top-0 p-4  shadow-sm items-center'>
        ...
        <ul className='hidden md:flex gap-4 uppercase font-medium'>
          {authState.isLoggedIn ? (
            <>
              ...
              <li className='bg-gray-500 py-2 px-3 text-red-600 rounded-md cursor-pointer hover:bg-gray-200 transition ' onClick={handleLogoutClick}>Logout</li>
            </>
          ) : (
